package com.codebind.io.week1.controller;

import com.codebind.io.week1.model.Movie;
import com.codebind.io.week1.model.Rater;
import edu.duke.*;
import java.util.*;
...
public class FirstRatings {
    ...
    private static final String Data_Path = "E:\\A Recommendation System\\A-Recommendation-System" +
											"\\Recommendation_System\\src\\resources\\data\\";
    ...
    public List<Movie> filterByGreaterThanMinimumLength(int minutes, List<Movie> allMovies) {
		return allMovies.stream().filter(movie -> movie.getMinutes() > minutes)
